      ...
      <DialogContent className="sm:max-w-lg rounded-[24px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-500 font-medium">
            Share your experience with Dr. {appointment?.doctor?.name ?? "your practitioner"}. Your feedback helps improve care quality.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 pt-3">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="comment"
              placeholder="Tell us what you liked, or where the practitioner can improve..."
