                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="space-y-2">
                      {(doctorDetails.reviews ?? []).slice(0, 5).map((review: NonNullable<IDoctorDetails["reviews"]>[number], index: number) => (
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="space-y-2">
                      {(doctorDetails.doctorSchedules ?? []).slice(0, 8).map((item: NonNullable<IDoctorDetails["doctorSchedules"]>[number], index: number) => (
